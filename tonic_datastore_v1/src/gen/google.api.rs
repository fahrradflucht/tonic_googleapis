...
pub struct CommonLanguageSettings {
    ...
    pub destinations: ::std::vec::Vec<i32>,
}
...
pub struct ClientLibrarySettings {
    ...
    pub java_settings: ::std::option::Option<JavaSettings>,
    /// Settings for C++ client libraries.
    #[prost(message, optional, tag = "22")]
    pub cpp_settings: ::std::option::Option<CppSettings>,
    /// Settings for PHP client libraries.
    #[prost(message, optional, tag = "23")]
    pub php_settings: ::std::option::Option<PhpSettings>,
    /// Settings for Python client libraries.
    #[prost(message, optional, tag = "24")]
    pub python_settings: ::std::option::Option<PythonSettings>,
    /// Settings for Node client libraries.
    #[prost(message, optional, tag = "25")]
    pub node_settings: ::std::option::Option<NodeSettings>,
    /// Settings for .NET client libraries.
    #[prost(message, optional, tag = "26")]
    pub dotnet_settings: ::std::option::Option<DotnetSettings>,
    /// Settings for Ruby client libraries.
    #[prost(message, optional, tag = "27")]
    pub ruby_settings: ::std::option::Option<RubySettings>,
    /// Settings for Go client libraries.
    #[prost(message, optional, tag = "28")]
    pub go_settings: ::std::option::Option<GoSettings>,
}
...
pub struct JavaSettings {
    ...
    pub common: ::std::option::Option<CommonLanguageSettings>,
}
/// Settings for C++ client libraries.
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct MethodSettings {
    ...
    pub long_running: ::std::option::Option<method_settings::LongRunning>,
}
pub mod method_settings {
    ...
    pub struct LongRunning {
        ...
        #[prost(message, optional, tag = "1")]
        pub initial_poll_delay: ::std::option::Option<::prost_types::Duration>,
        ...
        #[prost(message, optional, tag = "3")]
        pub max_poll_delay: ::std::option::Option<::prost_types::Duration>,
        /// Total polling timeout.
        /// Default value: 5 minutes.
        #[prost(message, optional, tag = "4")]
        pub total_poll_timeout: ::std::option::Option<::prost_types::Duration>,
    }
}
